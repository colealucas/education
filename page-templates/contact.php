                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="contact-body bg-light-green p-24px rounded-24px">
                            ...
                            <div class="mt-20px text-16px text-green">
                                <?php the_content(); ?>
                            </div>
                            ...
                            <div class="contact-boxes mt-40px flex flex-col gap-16px">
                                <div class="contact-box flex gap-20px p-20px rounded-20px bg-white">
                                    <div class="w-[42px]">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="41" height="41" viewBox="0 0 41 41" fill="none">
                                            ...
                                            <path d="M35.8045 17.3509C35.8045 29.0175 20.8045 39.0175 20.8045 39.0175C20.8045 39.0175 5.8045 29.0175 5.8045 17.3509C5.8045 13.3726 7.38486 9.55732 10.1979 6.74427C13.0109 3.93123 16.8263 2.35088 20.8045 2.35088C24.7828 2.35088 28.5981 3.93123 31.4111 6.74427C34.2241 9.55732 35.8045 13.3726 35.8045 17.3509Z" stroke="#00665E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M20.8045 22.3509C23.5659 22.3509 25.8045 20.1123 25.8045 17.3509C25.8045 14.5895 23.5659 12.3509 20.8045 12.3509C18.0431 12.3509 15.8045 14.5895 15.8045 17.3509C15.8045 20.1123 18.0431 22.3509 20.8045 22.3509Z" stroke="#00665E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                            </g>
                                            <defs>
                                ...
                                <div class="contact-box flex gap-20px p-20px rounded-20px bg-white">
                                    <div class="w-[42px]">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="41" height="41" viewBox="0 0 41 41" fill="none">
                                            <path d="M37.4712 10.3158C37.4712 8.48248 35.9712 6.98248 34.1378 6.98248H7.47115C5.63782 6.98248 4.13782 8.48248 4.13782 10.3158M37.4712 10.3158V30.3158C37.4712 32.1491 35.9712 33.6491 34.1378 33.6491H7.47115C5.63782 33.6491 4.13782 32.1491 4.13782 30.3158V10.3158M37.4712 10.3158L20.8045 21.9825L4.13782 10.3158" stroke="#00665E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                    </div>
                                    <div class="w-[calc(100%-62px)]">
                                    ...
                                    <a href="<?php the_field('linkedin_link'); ?>" class="size-80px rounded-50 bg-white flex items-center justify-center" target="_blank">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none">
                                            <g clip-path="url(#clip0_212_229)">
                                                <path d="M26.9 0H6.10003C3.00724 0 0.500031 2.50721 0.500031 5.6V26.4C0.500031 29.4928 3.00724 32 6.10003 32H26.9C29.9928 32 32.5 29.4928 32.5 26.4V5.6C32.5 2.50721 29.9928 0 26.9 0Z" fill="#00665E"/>
