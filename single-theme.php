...
$get_static_text = [
    ...
    'ru' => [
        ...
        'liceu' => [
            ...
            'go_back' => 'Назад к Темам',
            'concepts' => 'Ключевые Понятия',
            'step1' => 'Название этапа',
            'step2' => 'Название этапа',
            'step3' => 'Название этапа',
            'step4' => 'Название этапа',
            'step5' => 'Название этапа',
            'step6' => 'Название этапа',
        ],
    ]
];
...
<div style="display: none;" id="modal-4" class="w-[833px] p-24px rounded-24px">
    ...
    <div class="mt-12px pagination-wrapper bg-light-gray rounded-16px">
        <a href="#" class="theme-pagination-btn tp-button-left" data-fancybox data-src="<?php echo ($book_target == 'gimnaziu' ? '#modal-2' : '#modal-3'); ?>">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="15" viewBox="0 0 14 15" fill="none">
                <path d="M12.8334 7.50002H1.16669M1.16669 7.50002L7.00002 13.3334M1.16669 7.50002L7.00002 1.66669" stroke="currentColor" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round"></path>
            </svg>
            <?php echo $get_static_text[get_lang()]['pagination_back']; ?>
...
<div class="section py-32px theme-steps">
    <div class="container">
        <div class="parts flex flex-wrap gap-20px">
                ...
                <a href="javascript:;" data-fancybox data-src="#modal-1" class="step-box flex flex-col gap-20px justify-between bg-primary-light p-32px rounded-24px min-h-[300px]">
                    <span class="step-icon flex items-center justify-center size-[74px] rounded-50 bg-primary-medium">
                        <svg xmlns="http://www.w3.org/2000/svg" width="41" height="40" viewBox="0 0 41 40" fill="none">
                            ...
                            <path d="M7.65083 3.66861L5.08989 1.87551C4.92009 1.75618 4.70984 1.70919 4.50539 1.74487C4.30094 1.78056 4.11905 1.896 3.99972 2.0658C3.88039 2.23561 3.83339 2.44586 3.86908 2.6503C3.90477 2.85475 4.02021 3.03665 4.19001 3.15598L6.75095 4.94908C6.83503 5.00795 6.92988 5.04968 7.03008 5.0719C7.13029 5.09411 7.23389 5.09637 7.33496 5.07854C7.43604 5.06072 7.53262 5.02316 7.61918 4.96801C7.70574 4.91286 7.78059 4.8412 7.83946 4.75712C7.89833 4.67305 7.94006 4.5782 7.96228 4.47799C7.98449 4.37779 7.98675 4.27419 7.96892 4.17311C7.9511 4.07204 7.91354 3.97546 7.85839 3.8889C7.80324 3.80233 7.73158 3.72748 7.64751 3.66861H7.65083Z" fill="var(--primary-color)"/>
                            <path d="M35.8201 23.3905L33.2591 21.5974C33.1751 21.5385 33.0802 21.4968 32.98 21.4746C32.8798 21.4524 32.7762 21.4501 32.6751 21.4679C32.574 21.4857 32.4775 21.5233 32.3909 21.5785C32.3043 21.6336 32.2295 21.7053 32.1706 21.7893C32.1118 21.8734 32.07 21.9683 32.0478 22.0685C32.0256 22.1687 32.0234 22.2723 32.0412 22.3734C32.059 22.4744 32.0966 22.571 32.1517 22.6576C32.2069 22.7442 32.2785 22.819 32.3626 22.8779L34.9235 24.671C35.0076 24.7298 35.1024 24.7716 35.2026 24.7938C35.3028 24.816 35.4065 24.8183 35.5075 24.8004C35.6086 24.7826 35.7052 24.745 35.7917 24.6899C35.8783 24.6348 35.9531 24.5631 36.012 24.479C36.0709 24.3949 36.1126 24.3001 36.1348 24.1999C36.157 24.0997 36.1593 23.9961 36.1415 23.895C36.1237 23.7939 36.0861 23.6973 36.0309 23.6108C35.9758 23.5242 35.9042 23.4494 35.8201 23.3905Z" fill="var(--primary-color)"/>
                        </svg>
                    </span>

                    <h3 class="text-28px font-500 text-primary leading-120"><?php echo get_theme_translated_text('step1'); ?></h3>
            ...
            <?php if ( !$hide_step_3 ) : ?>
            <div class="w-full md:w-[calc(50%-20px)] lg:w-[calc(25%-20px)] part-col">
                <a href="javascript:;" data-fancybox data-src="#modal-3" class="step-box flex flex-col gap-20px justify-between bg-primary-light p-32px rounded-24px min-h-[300px]">
                    <span class="step-icon flex items-center justify-center size-[74px] rounded-50 bg-primary-medium">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                            <g clip-path="url(#clip0_92_907)">
                                <path d="M39.2008 11.2L28.8008 16.8V23.2L39.2008 28.8V11.2Z" stroke="var(--primary-color)" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"/>
                                <path d="M28.8008 28.8C28.8008 30.5672 27.368 32 25.6008 32H4.00078C2.23358 32 0.800781 30.5672 0.800781 28.8V11.2C0.800781 9.4328 2.23358 8 4.00078 8H25.6008C27.368 8 28.8008 9.4328 28.8008 11.2V28.8Z" stroke="var(--primary-color)" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"/>
                            </g>
                            <defs>
                    ...
                    <h3 class="text-28px font-500 text-primary leading-120"><?php echo get_theme_translated_text('step3'); ?></h3>
            ...
            <?php if ( !$hide_step_4 ) : ?>
            <div class="w-full md:w-[calc(50%-20px)] lg:w-[calc(25%-20px)] part-col">
                <a href="javascript:;" data-fancybox data-src="#modal-4" class="step-box flex flex-col gap-20px justify-between bg-primary-light p-32px rounded-24px min-h-[300px]">
                    <span class="step-icon flex items-center justify-center size-[74px] rounded-50 bg-primary-medium">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                            <path d="M6.66602 23.3333V30.6666C6.66602 31.219 7.11373 31.6666 7.66602 31.6666H16.666" stroke="var(--primary-color)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M31.6673 23.3333V30.6666C31.6673 31.219 31.2197 31.6666 30.6673 31.6666H23.334" stroke="var(--primary-color)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M23.334 8.33331H30.6673C31.2197 8.33331 31.6673 8.78103 31.6673 9.33331V16.6666" stroke="var(--primary-color)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M6.66602 16.6666V9.33331C6.66602 8.78103 7.11373 8.33331 7.66602 8.33331H16.666" stroke="var(--primary-color)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M23.3327 31.6667V33.3334C23.3327 35.1744 21.8403 36.6667 19.9993 36.6667C18.1583 36.6667 16.666 35.1744 16.666 33.3334V31.6667" stroke="var(--primary-color)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M6.66602 16.6667H8.33268C10.1736 16.6667 11.666 18.159 11.666 20C11.666 21.841 10.1736 23.3334 8.33268 23.3334H6.66602" stroke="var(--primary-color)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M31.666 16.6667H33.3327C35.1737 16.6667 36.666 18.159 36.666 20C36.666 21.841 35.1737 23.3334 33.3327 23.3334H31.666" stroke="var(--primary-color)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M23.3327 8.33331V6.66665C23.3327 4.8257 21.8403 3.33331 19.9993 3.33331C18.1583 3.33331 16.666 4.8257 16.666 6.66665V8.33331" stroke="var(--primary-color)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </span>
            ...
            <div class="w-full md:w-[calc(50%-20px)] lg:w-[calc(25%-20px)] part-col">
                <a href="javascript:;" data-fancybox data-src="#modal-6" class="step-box flex flex-col gap-20px justify-between bg-primary-light p-32px rounded-24px min-h-[300px]">
                    ...
                    <h3 class="text-28px font-500 text-primary leading-120"><?php echo get_theme_translated_text('step6'); ?></h3>
                </a>
            </div>
            <?php endif; ?>
        </div>
