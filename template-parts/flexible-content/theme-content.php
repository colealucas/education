                    ...
                    <tr style="background-color:<?php echo (($k % 2 == 0) ? 'rgba(253,161,114, 0.15)' : 'rgba(250,129,40, 0.2)') ?>">
                        ...
                        <td style="width: 50%">
                            <form action="#" method="POST" data-add-fields-form>
                                ...
                                <div class="p-6px mt-6px leading-130 bg-light-gray transition-all rounded-8px text-dark hover:bg-green hover:text-white font-500 text-14px text-center cursor-pointer select-none" data-add-field-btn><?php echo $get_static_text[get_lang()]['add_field']; ?></div>
                            </form>
                        </td>
                    </tr>
