document.addEventListener("DOMContentLoaded",function(){let n=education_theme_localized&&education_theme_localized.lang?education_theme_localized.lang:"ro",a={ro:{bravo:"Bravo",continue:"Continuă",wordsToFind:"cuvinte de găsit",wordsFound:"cuvinte descoperite"},ru:{bravo:"Браво",continue:"Продолжить",wordsToFind:"слов для поиска",wordsFound:"найденных слова"}};function s(t){let e="";return e=t&&a[n][t]?a[n][t]:e}Fancybox.bind("[data-fancybox]",{backdropClick:!1,closeButton:!0,closeExisting:!0,dragToClose:!1}),document.querySelector("#print-button")&&document.querySelector("#print-button").addEventListener("click",function(){window.print()}),window.location.hash&&(window.scrollTo(0,0),setTimeout(function(){var t=window.location.hash.substring(1),t=document.getElementById(t);t&&(t=t.getBoundingClientRect().top+window.scrollY,window.scrollTo({top:t-80,behavior:"smooth"}))},0));var t=document.querySelectorAll('a[href^="#"]:not([href="#"]):not(.ignore)');if(t.length)t.forEach(t=>{t.addEventListener("click",function(t){t.preventDefault();var t=document.querySelector(this.getAttribute("href"));t&&(t=t.getBoundingClientRect().top+window.scrollY,window.scrollTo({top:t-80,behavior:"smooth"}))})});(t=document.querySelectorAll("[data-toggle-active]"))&&t.forEach(function(t){t.addEventListener("click",function(t){t.preventDefault();t=this.getAttribute("data-toggle-active")?this.getAttribute("data-toggle-active"):null,t=t?document.querySelector(t):null;this.classList.toggle("active"),t&&t.classList.toggle("active")})}),document.querySelectorAll("[data-notion-title]").forEach(e=>{e.addEventListener("click",()=>{var t=e.nextElementSibling;e.parentNode.classList.toggle("open"),e.classList.contains("open")?(t.style.display="none",e.classList.remove("open")):(t.style.display="block",e.classList.add("open"))})});{let a=document.querySelectorAll("[data-voc-filter-link]");a.length&&a.forEach(function(e){e.onclick=function(t){t.preventDefault(),a.forEach(function(t){t!==e&&t.classList.remove("active")}),e.classList.toggle("active");{var t=document.querySelectorAll("[data-voc-filter-link]"),n=document.querySelectorAll("[data-notion-box]");let e=null;t.length&&(t.forEach(function(t){t.classList.contains("active")&&t.getAttribute("data-voc-letter")&&t.getAttribute("data-voc-letter").length&&(e=t.getAttribute("data-voc-letter").trim().toLowerCase())}),n.length)&&n.forEach(function(t){!1===(t.getAttribute("data-filter-letter")&&t.getAttribute("data-filter-letter")===e)?t.classList.add("hide"):t.classList.remove("hide")}),e||n.length&&n.forEach(function(t){t.classList.remove("hide")})}}})}function d(t){t=t||s("bravo")+"!";var e=s("continue");new Fancybox([{src:`<div class="py-40px px-24px rounded-24px min-w-[450px] flex flex-col gap-12px text-center">
                    ...
                    </div>`,type:"html"}],{backdropClick:!1,closeButton:!0,closeExisting:!1,dragToClose:!0,autoFocus:!1})}function l(t){t.dataTransfer.setData("text/plain",t.target.dataset.word)}function o(t){t.preventDefault()}function r(t){var e,n,a;t.target.classList.contains("correct")||(a=n=null,(e=t.dataTransfer.getData("text/plain"))===t.target.dataset.word?(t.target.classList.add("correct"),t.target.classList.remove("incorrect"),t.target.innerText=e,(e=document.querySelector(`.word[data-word="${e}"]`))&&e.remove()):t.target.classList.contains("correct")||(t.target.classList.add("incorrect"),t.target.classList.remove("correct")),t.target&&t.target.classList.contains("placeholder")&&((a=(n=t.target.closest(".match-definitions-wrap"))?n.querySelector(".words"):null)?a.querySelectorAll(".word").length<1&&(a.classList.add("hide"),d()):console.warn("cant find words..")))}(t=document.querySelectorAll(".check-paragraphs")).length&&t.forEach(function(t){t&&(t=t.querySelectorAll("p")).length&&(t.forEach(function(t){var e;t.textContent.trim().length&&((e=document.createElement("span")).classList.add("paragraph-check-options"),e.innerHTML=`<span class="known">
                                    <svg width="18px" height="18px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </span>

                                <span class="new">+</span>`,t.prepend(e))}),(t=document.querySelectorAll(".paragraph-check-options")).length)&&t.forEach(function(t){let e=t.querySelector(".known"),n=t.querySelector(".new");e&&n?(e.addEventListener("click",function(){n.classList.remove("active"),e.classList.add("active")}),n.addEventListener("click",function(){e.classList.remove("active"),n.classList.add("active")})):console.warn("Missing checkmark options!")})}),(t=document.querySelectorAll(".match-definitions-wrap")).length&&t.forEach(t=>{var e=t.querySelectorAll(".word"),t=t.querySelectorAll(".placeholder");e.forEach(t=>{t.addEventListener("dragstart",l)}),t.forEach(t=>{t.addEventListener("dragover",o),t.addEventListener("drop",r)})}),(t=document.querySelectorAll(".square-table-game")).length&&t.forEach(function(t){var e=t.getAttribute("data-words");let l=t.querySelector(".found-words"),o=t.querySelector(".game-status");t=t.querySelectorAll(".letter");let a=[],r=[];e=JSON.parse(e);if(!e||!e.length)return console.warn("Words table game missing words!"),!1;let c=e,i=[];c.length&&o&&(o.innerHTML=`<p class="text-center w-full">${c.length} ${s("wordsToFind")}</p>`),t.forEach((t,e)=>{t.addEventListener("click",function(){var t=r.indexOf(this);-1===t?(this.classList.add("selected"),a.push(this.dataset.letter.toLowerCase()),r.push(this)):(this.classList.remove("selected"),a.splice(t,1),r.splice(t,1));{let e=a.join(""),t=r.every((t,e,n)=>t.getAttribute("data-row")===n[0].getAttribute("data-row")),n=r.every((t,e,n)=>t.getAttribute("data-column")===n[0].getAttribute("data-column"));(t||n)&&c.forEach(t=>{if(function(t,e){if(t.length!==e.length)return;let n=t=>t.split("").reduce((t,e)=>(t[e]=(t[e]||0)+1,t),{}),a=n(t),l=n(e);return Object.keys(l).every(t=>l[t]===a[t])}(e,t.replace(/\s+/g,""))){if(r.forEach(t=>{t.classList.remove("selected"),t.classList.add("found")}),l)if(i.push(t),i.length>=c.length&&d(s("bravo")),i.length){let n=0,a=1;l.innerHTML="",i.forEach(function(t,e){e%4==0&&((e=document.createElement("ol")).setAttribute("start",a),e.classList.add("found-words-list"),l.appendChild(e));e=document.createElement("li");e.textContent=t,l.lastChild.appendChild(e),n++,a=n+1}),o&&(o.innerHTML=`<p class="text-center w-full">${i.length} / ${c.length} ${s("wordsFound")}</p>`)}else l.innerHTML="";a=[],r=[]}})}})})})});