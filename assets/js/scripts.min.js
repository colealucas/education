document.addEventListener("DOMContentLoaded",function(){let n=education_theme_localized&&education_theme_localized.lang?education_theme_localized.lang:"ro",o={ro:{bravo:"Bravo",continue:"Continuă",wordsToFind:"cuvinte de găsit",wordsFound:"cuvinte descoperite"},ru:{bravo:"Браво",continue:"Продолжить",wordsToFind:"слов для поиска",wordsFound:"найденных слова"}};function c(t){let e="";return e=t&&o[n][t]?o[n][t]:e}t=document.querySelectorAll('[class*="wp-image-"]'),console.log(t),t.length&&t.forEach(function(t){t=t.parentNode;"a"===t.nodeName.toLowerCase()&&t.setAttribute("theme-fancybox","")}),Fancybox.bind("[data-fancybox]",{backdropClick:!1,closeButton:!0,closeExisting:!0,dragToClose:!1,mainClass:"regular-lightbox"}),Fancybox.bind("[theme-fancybox]",{backdropClick:!0,closeButton:!0,closeExisting:!1,dragToClose:!1,mainClass:"image-lightbox"}),document.querySelector("#print-button")&&document.querySelector("#print-button").addEventListener("click",function(){window.print()}),window.location.hash&&(window.scrollTo(0,0),setTimeout(function(){var t=window.location.hash.substring(1),t=document.getElementById(t);t&&(t=t.getBoundingClientRect().top+window.scrollY,window.scrollTo({top:t-80,behavior:"smooth"}))},0));var t=document.querySelectorAll('a[href^="#"]:not([href="#"]):not(.ignore)');if(t.length)t.forEach(t=>{t.addEventListener("click",function(t){t.preventDefault();var t=document.querySelector(this.getAttribute("href"));t&&(t=t.getBoundingClientRect().top+window.scrollY,window.scrollTo({top:t-80,behavior:"smooth"}))})});(t=document.querySelectorAll("[data-toggle-active]"))&&t.forEach(function(t){t.addEventListener("click",function(t){t.preventDefault();t=this.getAttribute("data-toggle-active")?this.getAttribute("data-toggle-active"):null,t=t?document.querySelector(t):null;this.classList.toggle("active"),t&&t.classList.toggle("active")})}),document.querySelectorAll("[data-notion-title]").forEach(e=>{e.addEventListener("click",()=>{var t=e.nextElementSibling;e.parentNode.classList.toggle("open"),e.classList.contains("open")?(t.style.display="none",e.classList.remove("open")):(t.style.display="block",e.classList.add("open"))})});{let o=document.querySelectorAll("[data-voc-filter-link]");o.length&&o.forEach(function(e){e.onclick=function(t){t.preventDefault(),o.forEach(function(t){t!==e&&t.classList.remove("active")}),e.classList.toggle("active");{var t=document.querySelectorAll("[data-voc-filter-link]"),n=document.querySelectorAll("[data-notion-box]");let e=null;t.length&&(t.forEach(function(t){t.classList.contains("active")&&t.getAttribute("data-voc-letter")&&t.getAttribute("data-voc-letter").length&&(e=t.getAttribute("data-voc-letter").trim().toLowerCase())}),n.length)&&n.forEach(function(t){!1===(t.getAttribute("data-filter-letter")&&t.getAttribute("data-filter-letter")===e)?t.classList.add("hide"):t.classList.remove("hide")}),e||n.length&&n.forEach(function(t){t.classList.remove("hide")})}}})}function d(t){t=t||c("bravo")+"!";var e=c("continue");new Fancybox([{src:`<div class="py-40px px-24px rounded-24px min-w-[450px] flex flex-col gap-12px text-center">
                    ...
                    </div>`,type:"html"}],{backdropClick:!1,closeButton:!0,closeExisting:!1,dragToClose:!0,autoFocus:!1})}function l(t){t.dataTransfer.setData("text/plain",t.target.dataset.word)}function r(t){t.preventDefault()}function a(t){var e,n,o;t.target.classList.contains("correct")||(o=n=null,(e=t.dataTransfer.getData("text/plain"))===t.target.dataset.word?(t.target.classList.add("correct"),t.target.classList.remove("incorrect"),t.target.innerText=e,(e=document.querySelector(`.word[data-word="${e}"]`))&&e.remove()):t.target.classList.contains("correct")||(t.target.classList.add("incorrect"),t.target.classList.remove("correct")),t.target&&t.target.classList.contains("placeholder")&&((o=(n=t.target.closest(".match-definitions-wrap"))?n.querySelector(".words"):null)?o.querySelectorAll(".word").length<1&&(o.classList.add("hide"),d()):console.warn("cant find words..")))}(t=document.querySelectorAll(".check-paragraphs")).length&&t.forEach(function(t){t&&(t=t.querySelectorAll("p:not(:first-child):not(.ignore)")).length&&(t.forEach(function(t){var e;t.textContent.trim().length&&((e=document.createElement("span")).classList.add("paragraph-check-options"),e.innerHTML=`<span class="known">
                                    <svg width="18px" height="18px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </span>

                                <span class="new">+</span>`,t.prepend(e))}),(t=document.querySelectorAll(".paragraph-check-options")).length)&&t.forEach(function(t){let e=t.querySelector(".known"),n=t.querySelector(".new");e&&n?(e.addEventListener("click",function(){n.classList.remove("active"),e.classList.add("active")}),n.addEventListener("click",function(){e.classList.remove("active"),n.classList.add("active")})):console.warn("Missing checkmark options!")})}),(t=document.querySelectorAll(".match-definitions-wrap")).length&&t.forEach(t=>{var e=t.querySelectorAll(".word"),t=t.querySelectorAll(".placeholder");e.forEach(t=>{t.addEventListener("dragstart",l)}),t.forEach(t=>{t.addEventListener("dragover",r),t.addEventListener("drop",a)})}),(t=document.querySelectorAll(".square-table-game")).length&&t.forEach(function(t){var e=t.getAttribute("data-words");let l=t.querySelector(".found-words"),r=t.querySelector(".game-status");t=t.querySelectorAll(".letter");let o=[],a=[];e=JSON.parse(e);if(!e||!e.length)return console.warn("Words table game missing words!"),!1;let i=e,s=[];i.length&&r&&(r.innerHTML=`<p class="text-center w-full">${i.length} ${c("wordsToFind")}</p>`),t.forEach((t,e)=>{t.addEventListener("click",function(){var t=a.indexOf(this);-1===t?(this.classList.add("selected"),o.push(this.dataset.letter.toLowerCase()),a.push(this)):(this.classList.remove("selected"),o.splice(t,1),a.splice(t,1));{let e=o.join(""),t=a.every((t,e,n)=>t.getAttribute("data-row")===n[0].getAttribute("data-row")),n=a.every((t,e,n)=>t.getAttribute("data-column")===n[0].getAttribute("data-column"));(t||n)&&i.forEach(t=>{if(function(t,e){if(t.length!==e.length)return;let n=t=>t.split("").reduce((t,e)=>(t[e]=(t[e]||0)+1,t),{}),o=n(t),l=n(e);return Object.keys(l).every(t=>l[t]===o[t])}(e,t.replace(/\s+/g,""))){if(a.forEach(t=>{t.classList.remove("selected"),t.classList.add("found")}),l)if(s.push(t),s.length>=i.length&&d(c("bravo")),s.length){let n=0,o=1;l.innerHTML="",s.forEach(function(t,e){e%4==0&&((e=document.createElement("ol")).setAttribute("start",o),e.classList.add("found-words-list"),l.appendChild(e));e=document.createElement("li");e.textContent=t,l.lastChild.appendChild(e),n++,o=n+1}),r&&(r.innerHTML=`<p class="text-center w-full">${s.length} / ${i.length} ${c("wordsFound")}</p>`)}else l.innerHTML="";o=[],a=[]}})}})})}),(t=document.querySelectorAll(".match-arrows-game")).length&&t.forEach(function(s){var t=s.querySelectorAll(".ma-item-left"),e=s.querySelectorAll(".ma-item-right");let n=t.length,o=0,l=null,r=null,a=!1;function i(t,e,n){let o=s.querySelector(".ma-arrows");var t=t.getBoundingClientRect(),e=e.getBoundingClientRect(),l=s.querySelector(".ma-container").getBoundingClientRect(),r=t.right-l.left,t=t.top+t.height/2-l.top,a=e.left-l.left,e=e.top+e.height/2-l.top;let i=document.createElementNS("http://www.w3.org/2000/svg","line");i.setAttribute("x1",r),i.setAttribute("y1",t),i.setAttribute("x2",a),i.setAttribute("y2",e),i.setAttribute("marker-end","url(#arrowhead)"),i.setAttribute("style","stroke: #808285; stroke-width: 2;"),o.appendChild(i),l=s.querySelector(".ma-arrows"),(r=document.createElementNS("http://www.w3.org/2000/svg","marker")).setAttribute("id","arrowhead"),r.setAttribute("markerWidth","10"),r.setAttribute("markerHeight","7"),r.setAttribute("refX","10"),r.setAttribute("refY","3.5"),r.setAttribute("orient","auto"),r.setAttribute("markerUnits","strokeWidth"),(t=document.createElementNS("http://www.w3.org/2000/svg","path")).setAttribute("d","M0,0 L10,3.5 L0,7 Z"),t.setAttribute("style","fill: #808285;"),r.appendChild(t),l.appendChild(r),n||setTimeout(()=>{o.removeChild(i)},650)}t.length&&t.forEach(function(t){t.onclick=function(t){t.preventDefault(),l||((l=this).classList.contains("connected")?l=null:l.classList.add("selected"))}}),e.length&&e.forEach(function(t){t.onclick=function(t){t.preventDefault(),r=this,l=(l&&!l.classList.contains("connected")&&(!function(t,e){if(t&&e)return t.dataset.id===e.dataset.id}(l,r)?(a=!1,l.classList.remove("connected"),l.classList.remove("selected"),i(l,r,!1),r.classList.add("error"),setTimeout(()=>{r.classList.remove("error"),r=null},650)):(a=!0,l.classList.add("connected"),l.classList.remove("selected"),i(l,r,!0),r.classList.add("success"),++o>=n&&d(c("bravo")))),null)}})})});